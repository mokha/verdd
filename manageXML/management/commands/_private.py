...
def parseXML(filename, lang='fin'):
    with io.open(filename, 'r', encoding='utf-8') as fp:
        ...
        for e in root.findall('e'):
            map_e = e.find('map')
            sml_true = True if (map_e is not None and 'sml_ids' in map_e.attrib) else False

            book_sources = e.findall('sources/book')
            sjm_source = [True if 'name' in b.attrib and b.attrib['name'] == 'sjm' else False for b in book_sources]
...
def fix_encoding(text):
    # wrong -> correct
    encodings_map = {"ð": "đ", "ä": "ä", "Ä": "Ä", "Ö": "Ö", "ö̈": "ö", "â": "â", "Â": "Â", "å": "å",
                     "Å": "Å", "õ": "õ", "Õ": "Õ", "č": "č", "Č": "Č", "ǯ": "ǯ", "Ǯ": "Ǯ", "ǧ": "ǧ",
                     "Ǧ": "Ǧ", "ǩ": "ǩ", "Ǩ": "Ǩ", "š": "š", "Š": "Š", "ž": "ž", "Ž": "Ž", "ğ": "ǧ",
                     "Ğ": "Ǧ",
                     "Ẹ": "Ẹ", "ẹ": "ẹ", "a'": "aˈ", "ä'": "äˈ", "â'": "âˈ", "å'": "åˈ", "õ'": "õˈ",
                     "i'": "iˈ",
                     "e'": "eˈ", "u'": "uˈ", "y'": "yˈ", "ö'": "öˈ", "a´": "aˈ", "ä´": "äˈ", "â´": "âˈ",
                     "å´": "åˈ",
                     "õ´": "õˈ", "i´": "iˈ", "e´": "eˈ", "u´": "uˈ", "y´": "yˈ", "ö´": "öˈ", "a′": "aʹ",
                     "ä′": "äʹ",
                     "â′": "âʹ", "å′": "åʹ", "õ′": "õʹ", "i′": "iʹ", "e′": "eʹ", "u′": "uʹ", "y′": "yʹ",
                     "ö′": "öʹ", "aˊ": "aʹ", "äˊ": "äʹ", "âˊ": "âʹ", "åˊ": "åʹ", "õˊ": "õʹ",
                     "iˊ": "iʹ",
                     "eˊ": "eʹ", "uˊ": "uʹ", "yˊ": "yʹ", "öˊ": "öʹ", "b´b": "bˈb", "c´c": "cˈc", "č´č": "čˈč",
                     "ʒ´ʒ": "ʒˈʒ", "ǯ´ǯ": "ǯˈǯ", "d´d": "dˈd", "đ´đ": "đˈđ", "z´z": "zˈz", "ž´ž": "žˈž",
                     "f´f": "fˈf",
                     "g´g": "gˈg", "ǩ´ǩ": "ǩˈǩ", "ǥ´ǥ": "ǥˈǥ", "ǧ´ǧ": "ǧˈǧ", "ŋ´ŋ": "ŋˈŋ", "j´j": "jˈj",
                     "k´k": "kˈk",
                     "l´l": "lˈl", "m´m": "mˈm", "n´n": "nˈn", "p´p": "pˈp", "r´r": "rˈr", "s´s": "sˈs",
                     "t´t": "tˈt",
                     "v´v": "vˈv", "b'b": "bˈb", "c'c": "cˈc", "č'č": "čˈč", "ʒ'ʒ": "ʒˈʒ", "ǯ'ǯ": "ǯˈǯ",
                     "d'd": "dˈd",
                     "đ'đ": "đˈđ", "z'z": "zˈz", "ž'ž": "žˈž", "f'f": "fˈf", "g'g": "gˈg", "ǩ'ǩ": "ǩˈǩ",
                     "ǥ'ǥ": "ǥˈǥ",
                     "ǧ'ǧ": "ǧˈǧ", "ŋ'ŋ": "ŋˈŋ", "j'j": "jˈj", "k'k": "kˈk", "l'l": "lˈl", "m'm": "mˈm",
                     "n'n": "nˈn",
                     "p'p": "pˈp", "r'r": "rˈr", "s's": "sˈs", "t't": "tˈt", "v'v": "vˈv", "b’": "bˈ",
                     "c’": "cˈ",
                     "č’": "čˈ", "ʒ’": "ʒˈ", "ǯ’": "ǯˈ", "d’": "dˈ", "đ’": "đˈ", "z’": "zˈ", "ž’": "žˈ",
                     "f’": "fˈ",
                     "g’": "gˈ", "ǩ’": "ǩˈ", "ǥ’": "ǥˈ", "ǧ’": "ǧˈ", "ŋ’": "ŋˈ", "j’": "jˈ", "k’": "kˈ",
                     "l’": "lˈ",
                     "m’": "mˈ", "n’": "nˈ", "p’": "pˈ", "r’": "rˈ", "s’": "sˈ", "t’": "tˈ", "v’": "vˈ",
                     "b´": "bˈ",
                     "c´": "cˈ", "č´": "čˈ", "ʒ´": "ʒˈ", "ǯ´": "ǯˈ", "d´": "dˈ", "đ´": "đˈ", "z´": "zˈ",
                     "ž´": "žˈ",
                     "f´": "fˈ", "g´": "gˈ", "ǩ´": "ǩˈ", "ǥ´": "ǥˈ", "ǧ´": "ǧˈ", "ŋ´": "ŋˈ", "j´": "jˈ",
                     "k´": "kˈ",
                     "l´": "lˈ", "m´": "mˈ", "n´": "nˈ", "p´": "pˈ", "r´": "rˈ", "s´": "sˈ", "t´": "tˈ",
                     "v´": "vˈ"}
