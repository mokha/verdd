...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        dup_criteria = (
            ...
            {
                'model': Stem,
                'unique_fields': ('lexeme', 'text',),
                'fields': ('id', 'lexeme__id', 'lexeme__language', 'lexeme__pos', 'text', 'contlex'),
                'sort': '-contlex',
        ...
        for criteria in dup_criteria:
            ...
            for dd in duplicates:  # for each duplicate values
                ...
                dup_line = []
                for _d in d_objects:
                    dup_str = obj_to_txt(_d, fields=fields_to_print, delimiter=delimiter)  # convert them to text
