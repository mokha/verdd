    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(blank=True, choices=[(1, 'Specification')], default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=3)),
                ('type', models.IntegerField(blank=True, choices=[(1, 'Specification')], default=None, null=True)),
                ('changed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='relation_metadata', to=settings.AUTH_USER_MODEL)),
