# Generated by Django 2.2.1 on 2020-06-11 01:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.CharField(max_length=250)),
                ('changed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lexeme_metadata', to=settings.AUTH_USER_MODEL)),
